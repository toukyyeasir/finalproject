...
?> 
    ...
    $dbname = "wtj";
      ...
      if (isset($_POST['search']))
      {
        ...
        $query2 ="SELECT * FROM `user` WHERE `userName` LIKE '%$src%' ";
        ...
        while ($row = mysqli_fetch_array($stmt2))
        {
          ...
          <tr>
            ...
            <td> <?php echo $row['lastName'];  ?> </td>
             ...
             <td>
            <a class="loginButtonstl" style="background-color: #4CAF50; color:black;" href="16_otherAdminProfile.php?user=<?php echo $row['userName']; ?>"  > View  </a> 
