...
<div class="dropdown">
  ...
  <div class="headerleft">
    ...
    <div><a class="loginButtonstl" style="margin-right: 20px; width: 200px; padding: 20px;" href=""><h2> Edit Profile  </h2></a>  </div>
<br>
...
<br><br>
    ...
    $dbname = "wtj";
        ...
        $querry = "SELECT * FROM `jobprovider` WHERE `UserName` = '$_GET[user]' ";
...
<script>
    ...
    function submit() {
      ...
      var password = document.getElementById("password").value;
        ...
        xhttp.open("POST", "18_jobProviderReview.php", true);
    ...
    function search() {
      ...
      xhttp.open("GET", "18_jobProviderReview.php?searchKey=" + searchKey, true);
      xhttp.send();
    }
