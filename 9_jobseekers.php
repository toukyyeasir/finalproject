...
<div class="dropdown">
 ...
 <!--  <h2 style="text-align: right;"></h2> -->
  ...
  <div class="headerleft">
    ...
    <div><a class="loginButtonstl" style="margin-right: 20px; width: 200px; padding: 20px;" href="10_addJobseekers.php"><h2> + ADD Job Seeker  </h2></a>                </div>
...
?> 
    ...
    $dbname = "wtj";
      ...
      if (isset($_POST['search']))
      {
        ...
        $query2 ="SELECT * FROM `jobseeker` WHERE `userName` LIKE '%$src%' ";
        ...
        while ($row = mysqli_fetch_array($stmt2))
        {
          ...
          <tr>
            ...
            <td> <a style="color: black; font-size: 25px; " href="11_jobseekerProfile.php"> <?php echo $row['userName'];  ?></a></td>
    ...
    echo "<br>";
        ...
        { 
          ...
          <tr>
           ...
           <a style="color: black; font-size: 25px; " href="jobseekerprofilejump.php"> <?php echo $row['userName'];  ?></a>
            ...
            <td>
            <a class="loginButtonstl" style="background-color: #4CAF50; color:black;" href="11_jobseekerProfile.php?user=<?php echo $row['userName']; ?>"  > View  </a> 
