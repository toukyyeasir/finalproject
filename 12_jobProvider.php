...
<div class="dropdown">
 ...
 <!--  <h2 style="text-align: right;"></h2> -->
  ...
  <div class="headerleft">
    ...
    <div><a class="loginButtonstl" style="margin-right: 20px; width: 200px; padding: 20px;" href="13_addJobProvider.php"><h2> + ADD Company  </h2></a>                </div>
...
?> 
    ...
    $dbname = "wtj";
      ...
      if (isset($_POST['search']))
      {
        ...
        $query2 ="SELECT * FROM `jobprovider` WHERE `userName` LIKE '%$src%' ";
        ...
        while ($row = mysqli_fetch_array($stmt2))
        {
          ...
          <tr>
            ...
            <td> <?php echo $row['CompanyName'];  ?> </td>
             ...
             <td>
            <a class="loginButtonstl" style="background-color: #4CAF50; color:black;" href="14_jobProviderProfile.php?user=<?php echo $row['userName']; ?>"  > View  </a> 
    ...
    echo "<br>";
          ...
          $querry = "SELECT * FROM `jobprovider` ";
